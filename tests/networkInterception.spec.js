...
async function loginAndGoToEvents(page) {
  ...
  await page.getByLabel("Email").fill("amitbyale77@gmail.com");
...
// ======================================================
// TEST 1 — Banner visible when 6 events returned
// ======================================================
...
test('Banner IS visible when 6 events are returned', async ({ page }) => {
  ...
  // Step 3 — Verify event cards
  const cards = page.getByTestId("event-card");

  await expect(cards.first()).toBeVisible();
  await expect(cards).toHaveCount(6);

  // Step 4 — Verify banner visible
...
// ======================================================
// TEST 2 — Banner hidden when 4 events returned
// ======================================================
